  ...
  return (
    ...
    >
      ...
      <section className="flex items-center gap-20">
        ...
        <div className="relative flex items-center gap-10 overflow-hidden ml-5 group">
          <MoveLeft className="w-4 h-4 md:w-5 md:h-5 lg:w-15 lg:h-15 text-black group-hover:text-orange-500 rotate-30 group-hover:rotate-0 transition-transform duration-300" />
          <a
            href="https://stanect.com"
            className={`block text-lg md:text-lg lg:text-4xl font-bold tracking-tighter hover:text-orange-600  underline hover:no-underline transition-all ${pixel.className}`}
          >
            STANECT
          </a>
      ...
      <section className="flex items-center">
        <div className="relative flex items-center gap-10 overflow-hidden ml-5 group">
          ...
          <span className="absolute bottom-0 left-0 w-full h-[2px] md:h-[3px] bg-orange-500 transform translate-x-[-101%] group-hover:translate-x-0 transition-transform duration-500 ease-in-out" />
          <MoveRight className="w-4 h-4 md:w-5 md:h-5 lg:w-15 lg:h-15 text-black group-hover:text-orange-500 rotate-30 group-hover:rotate-0 transition-transform duration-300" />
        </div>
        <motion.section
          variants={sectionVariants}
          initial="hidden"
